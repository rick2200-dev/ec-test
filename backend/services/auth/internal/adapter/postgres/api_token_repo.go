...
// only persists the already-hashed value. When ctx carries a transaction it
// joins that transaction (e.g. to perform an RBAC check and the insert
// atomically); otherwise opens its own.
