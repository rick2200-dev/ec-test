...
// SKULookup is the subset of catalog SKU fields the cart needs.
...
// LookupSKU fetches a SKU by ID from the catalog service. The catalog
// service exposes GET /internal/skus/{id} for intra-cluster use.
func (c *CatalogClient) LookupSKU(ctx context.Context, tenantID, skuID uuid.UUID) (*SKULookup, error) {
