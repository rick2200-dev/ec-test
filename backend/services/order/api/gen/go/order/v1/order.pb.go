...
func (x *CreateCheckoutRequest) GetShippingAddressJson() string {
	if x != nil {
		return x.ShippingAddressJson
	}
	return ""
...
func (x *CreateCheckoutRequest) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
func (x *CreateCheckoutRequest) GetLines() []*CheckoutLineInput {
	if x != nil {
		return x.Lines
	}
	return nil
...
func (x *CheckoutLineInput) Reset() {
	*x = CheckoutLineInput{}
...
func (x *CheckoutLineInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckoutLineInput) ProtoMessage() {}

func (x *CheckoutLineInput) ProtoReflect() protoreflect.Message {
	mi := &file_order_v1_order_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckoutLineInput.ProtoReflect.Descriptor instead.
func (*CheckoutLineInput) Descriptor() ([]byte, []int) {
	return file_order_v1_order_proto_rawDescGZIP(), []int{7}
}

func (x *CheckoutLineInput) GetSkuId() string {
	if x != nil {
		return x.SkuId
	}
	return ""
...
func (x *CheckoutLineInput) GetSellerId() string {
	if x != nil {
		return x.SellerId
	}
	return ""
...
func (x *CheckoutLineInput) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *CheckoutLineInput) GetUnitPriceSnapshot() *v1.Money {
	if x != nil {
...
func (x *CheckoutLineInput) GetProductNameSnapshot() string {
	if x != nil {
...
func (x *CheckoutLineInput) GetSkuCodeSnapshot() string {
	if x != nil {
...
func (x *CreateCheckoutResponse) GetOrders() []*Order {
	if x != nil {
		return x.Orders
	}
	return nil
...
func (x *CreateCheckoutResponse) GetStripeClientSecret() string {
	if x != nil {
		return x.StripeClientSecret
	}
	return ""
...
func (x *CreateCheckoutResponse) GetStripePaymentIntentId() string {
	if x != nil {
		return x.StripePaymentIntentId
	}
	return ""
...
func (x *CreateCheckoutResponse) GetTotal() *v1.Money {
	if x != nil {
		return x.Total
	}
	return nil
...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\border.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16common/v1/common.proto\"\x93\x05\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x11sku_code_snapshot\x18\x06 \x01(\tR\x0fskuCodeSnapshot\"\xd4\x01\n" +
	...
	"\arequest\x18\x01 \x01(\v2\x1d.order.v1.CancellationRequestR\arequest2\xb3\f\n" +
	"\fOrderService\x12l\n" +
	"\x0eCreateCheckout\x12\x1f.order.v1.CreateCheckoutRequest\x1a .order.v1.CreateCheckoutResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/checkout\x12O\n" +
	"\vCreateOrder\x12\x1c.order.v1.CreateOrderRequest\x1a\x1d.order.v1.CreateOrderResponse\"\x03\x88\x02\x01\x12Z\n" +
	"\bGetOrder\x12\x19.order.v1.GetOrderRequest\x1a\x1a.order.v1.GetOrderResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/orders/{id}\x12p\n" +
	"\x0fListBuyerOrders\x12 .order.v1.ListBuyerOrdersRequest\x1a!.order.v1.ListBuyerOrdersResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/buyer/orders\x12t\n" +
	"\x10ListSellerOrders\x12!.order.v1.ListSellerOrdersRequest\x1a\".order.v1.ListSellerOrdersResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/seller/orders\x12\x7f\n" +
	"\x11UpdateOrderStatus\x12\".order.v1.UpdateOrderStatusRequest\x1a#.order.v1.UpdateOrderStatusResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\x1a\x16/v1/orders/{id}/status\x12_\n" +
	"\vListPayouts\x12\x1c.order.v1.ListPayoutsRequest\x1a\x1d.order.v1.ListPayoutsResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/payouts\x12\xa8\x01\n" +
	"\x18RequestOrderCancellation\x12).order.v1.RequestOrderCancellationRequest\x1a*.order.v1.RequestOrderCancellationResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/orders/{order_id}/cancellation-request\x12\xa4\x01\n" +
	"\x18ApproveOrderCancellation\x12).order.v1.ApproveOrderCancellationRequest\x1a*.order.v1.ApproveOrderCancellationResponse\"1\x82\xd3\xe4\x93\x02+:\x01*\"&/v1/cancellation-requests/{id}/approve\x12\xa0\x01\n" +
	"\x17RejectOrderCancellation\x12(.order.v1.RejectOrderCancellationRequest\x1a).order.v1.RejectOrderCancellationResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/cancellation-requests/{id}/reject\x12\xa3\x01\n" +
	"\x1dListOrderCancellationRequests\x12..order.v1.ListOrderCancellationRequestsRequest\x1a/.order.v1.ListOrderCancellationRequestsResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/v1/cancellation-requests\x12\xa2\x01\n" +
	"\x1bGetOrderCancellationRequest\x12,.order.v1.GetOrderCancellationRequestRequest\x1a-.order.v1.GetOrderCancellationRequestResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/cancellation-requests/{id}BIZGgithub.com/Riku-KANO/ec-test/services/order/api/gen/go/order/v1;orderv1b\x06proto3"
