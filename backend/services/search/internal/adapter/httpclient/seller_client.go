// Package httpclient contains outbound HTTP adapters for the search
// service. Mirrors the order service's client since both services snapshot
// seller_name at projection-update time rather than reading auth_svc
// directly.
package httpclient
...
// /internal/sellers/batch-get endpoint.
...
// NewSellerClient constructs a client pointing at auth's base URL.
