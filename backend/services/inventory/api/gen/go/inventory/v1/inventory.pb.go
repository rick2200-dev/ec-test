...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16common/v1/common.proto\"\x9a\x02\n" +
	...
	"\x04item\x18\x01 \x01(\v2\x1b.inventory.v1.InventoryItemR\x04item2\xf3\x04\n" +
	"\x10InventoryService\x12u\n" +
	"\fGetInventory\x12!.inventory.v1.GetInventoryRequest\x1a\".inventory.v1.GetInventoryResponse\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/v1/inventory/{sku_id}\x12o\n" +
	"\rListInventory\x12\".inventory.v1.ListInventoryRequest\x1a#.inventory.v1.ListInventoryResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/inventory\x12u\n" +
	"\vUpdateStock\x12 .inventory.v1.UpdateStockRequest\x1a!.inventory.v1.UpdateStockResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\x1a\x16/v1/inventory/{sku_id}\x12U\n" +
	...
	"\vConfirmSold\x12 .inventory.v1.ConfirmSoldRequest\x1a!.inventory.v1.ConfirmSoldResponseBUZSgithub.com/Riku-KANO/ec-test/services/inventory/api/gen/go/inventory/v1;inventoryv1b\x06proto3"
