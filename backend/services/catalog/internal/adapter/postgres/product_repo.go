...
// ProductFilter is re-exported from domain for backwards compatibility.
// New code should prefer domain.ProductFilter.
//
// Deprecated: use domain.ProductFilter.
type ProductFilter = domain.ProductFilter
