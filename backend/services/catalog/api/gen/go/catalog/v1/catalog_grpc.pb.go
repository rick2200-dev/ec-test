...
//
// CatalogService provides product and category management. The HTTP
// annotations below describe the service's own REST surface; the gateway
// prefixes them with /api/v1/{buyer,seller} when routing externally.
