...
const file_shipping_v1_shipping_proto_rawDesc = "" +
	"\n" +
	"\x1ashipping/v1/shipping.proto\x12\vshipping.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9c\x04\n" +
	"\bShipment\x12\x0e\n" +
	...
	"\n" +
	"updated_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtJ\x04\b\x02\x10\x03R\ttenant_id\"G\n" +
	"\x19GetShipmentByOrderRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderIdJ\x04\b\x02\x10\x03R\ttenant_id\"O\n" +
	"\x1aGetShipmentByOrderResponse\x121\n" +
	"\bshipment\x18\x01 \x01(\v2\x15.shipping.v1.ShipmentR\bshipment\"\xe9\x01\n" +
	...
	"\n" +
	"shipped_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tshippedAtJ\x04\b\x02\x10\x03R\ttenant_id\"M\n" +
	"\x18RegisterShipmentResponse\x121\n" +
	"\bshipment\x18\x01 \x01(\v2\x15.shipping.v1.ShipmentR\bshipment\"\x93\x01\n" +
	"\x14MarkDeliveredRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\tseller_id\x18\x03 \x01(\tR\bsellerId\x12=\n" +
	"\fdelivered_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vdeliveredAtJ\x04\b\x02\x10\x03R\ttenant_id\"J\n" +
	"\x15MarkDeliveredResponse\x121\n" +
	"\bshipment\x18\x01 \x01(\v2\x15.shipping.v1.ShipmentR\bshipment2\xaa\x03\n" +
	"\x0fShippingService\x12\x8d\x01\n" +
	"\x12GetShipmentByOrder\x12&.shipping.v1.GetShipmentByOrderRequest\x1a'.shipping.v1.GetShipmentByOrderResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/orders/{order_id}/shipment\x12\x87\x01\n" +
	"\x10RegisterShipment\x12$.shipping.v1.RegisterShipmentRequest\x1a%.shipping.v1.RegisterShipmentResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/shipments/{id}/register\x12}\n" +
	"\rMarkDelivered\x12!.shipping.v1.MarkDeliveredRequest\x1a\".shipping.v1.MarkDeliveredResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/shipments/{id}/deliverBRZPgithub.com/Riku-KANO/ec-test/services/shipping/api/gen/go/shipping/v1;shippingv1b\x06proto3"
