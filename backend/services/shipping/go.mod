module github.com/Riku-KANO/ec-test/services/shipping

go 1.25.3

replace github.com/Riku-KANO/ec-test/pkg => ../../pkg

replace github.com/Riku-KANO/ec-test/services/shipping/api/gen/go => ./api/gen/go
...
require (
	...
	github.com/Riku-KANO/ec-test/shared/api/gen/go v0.0.0-00010101000000-000000000000 // indirect
