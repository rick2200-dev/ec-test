...
const navItems = [
  ...
  { href: "/orders", label: "注文管理", icon: "shopping-cart" },
  { href: "/inventory", label: "在庫管理", icon: "warehouse" },
  { href: "/sales", label: "売上・入金", icon: "trending-up" },
  ...
  return (
    ...
    >
      <div className="h-16 flex items-center justify-between px-4 border-b border-primary-light">
        {!collapsed && (
          <span className="font-bold text-lg tracking-wide">Seller Admin</span>
        )}
        <button
      ...
      <div className="p-4 border-t border-primary-light">
        {!collapsed && (
          <p className="text-xs text-gray-400">EC Marketplace v0.1</p>
        )}
      </div>
    </aside>
  );
