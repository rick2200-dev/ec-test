...
export interface InquiryListProps {
  ...
  openLabel: string;
  closedLabel: string;
  /** Builds the destination link for a given inquiry id (buyer vs seller routes differ). */
  buildHref: (id: string) => string;
  /** Locale passed to toLocaleString for date formatting. */
  locale: string;
}
